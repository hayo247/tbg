...
function send_email(){
	...
	if($("#agree_privacy:checked").length == 0 ){
		layer_popup($("#layer_alert"), "A", '개인정보 취급동의에 체크해주세요.', $("#agree_privacy:checked"));
		return;
	}	
	...
	$.ajax({
		data : queryString,
		type : 'post',
		url : 'https://script.google.com/macros/s/AKfycbwqAzdEG0y5ZxaAPismoNARc889g-6w2orxTwi61tV5WG0tlTmjkQ5gahVpT7s3FTqL/exec',
		dataType : 'json',
